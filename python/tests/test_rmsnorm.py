...
def test_rmsnorm(runtime, torch_rng_seed):
    ...
    input_t = builder.tensor(infinitensor.ShapeExpr(list(input_shape)), infinitensor.dtype_from_string("float32"))
    weight_t = builder.tensor(infinitensor.ShapeExpr([hidden_size]), infinitensor.dtype_from_string("float32"))
